...
describe ("city should contains 3 houses", () => {
    it("city should contains 3 houses", () => {
...
describe("city should contains hospital and fire station", () => {
    it("city should contains hospital and fire station", () => { 
